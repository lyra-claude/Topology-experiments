#!/usr/bin/env bash
# Maze-phenotype directed cycle experiment
# 30 runs x 8 directed topologies x 500 generations
# 8 islands, pop 50 per island, migration every 10 gens, 5 migrants
# Domain: 8x8 maze with composite fitness + Jaccard distance
# Same parameters as OneMax directed experiment for comparability.

set -euo pipefail

OUTDIR="results/maze_directed"
mkdir -p "$OUTDIR"
...
# 30 seeds (same as OneMax directed experiment)
