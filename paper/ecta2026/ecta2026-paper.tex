...
Against this consensus, BIGMAS~\cite{bigmas2026} permits cycles and
Puppeteer~\cite{puppeteer2025} discovers cyclic structures under optimization
pressure. The field is split, with no shared framework to adjudicate.
